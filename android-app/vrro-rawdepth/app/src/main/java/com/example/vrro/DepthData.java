...
public class DepthData {
    ...
    public static FloatBuffer create(Frame frame, Anchor cameraPoseAnchor) {
        try {
            ...
            final FloatBuffer points = convertRawDepthImagesTo3dPointBuffer(depthImage, confidenceImage,
                    intrinsics, modelMatrix);
            depthImage.close();
    ...
    private static FloatBuffer convertRawDepthImagesTo3dPointBuffer(Image depth, Image confidence,
                                        CameraIntrinsics cameraTextureIntrinsics, float[] modelMatrix) {
        ...
        final float maxNumberOfPointsToRender = 1000;
