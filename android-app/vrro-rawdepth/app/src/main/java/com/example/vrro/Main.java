...
import com.example.common.helpers.TrackingStateHelper;
import com.example.common.rendering.BackgroundRenderer;
import com.example.common.rendering.DepthRenderer;
...
public class Main extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        try {
            ...
            Log.e(TAG, "Failed to create depthRenderer");
        }
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        try {
            ...
            float[] cameraPose;
            cameraPose = frame.getCamera().getPose().getTranslation();
            Streamer.stream(cameraPose, points);
        } catch (Throwable t) {
